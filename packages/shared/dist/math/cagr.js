 ...
 */
export const calculateCAGR = (input) => {
    try {
        // 输入验证
 ...
 */
export const calculateTargetPrice = (currentPrice, targetCAGR, years) => {
    try {
 ...
 */
export const calculateRequiredTime = (buyPrice, sellPrice, targetCAGR) => {
    try {
 ...
 * 批量计算多个投资的CAGR，用于比较
 */
export const batchCalculateCAGR = (investments) => {
    try {
