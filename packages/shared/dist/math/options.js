 ...
 */
const payoffPerShare = (type, direction, S, K, premium) => {
 ...
 */
export const calculateOptionPL = (input) => {
    try {
 ...
 */
export const generateOptionPayoffCurve = (type, K, premium, lots, multiplier = 100, points = 50) => {
    const rawType = type;
    let direction = 'long';
    let optionType;
    if (rawType === 'short_call') {
