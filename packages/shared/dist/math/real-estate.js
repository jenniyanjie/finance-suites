 ...
 */
export const calculateRealEstateReturn = (input) => {
    try {
        // 输入验证
 ...
 */
export const calculateRequiredAppreciation = (propertyPrice, leverageRatio, loanRate, rentYield, targetROE) => {
    try {
 ...
 * 批量对比不同杠杆比例的投资回报
 */
export const batchCompareRealestate = (baseInput, leverageRatios) => {
    try {
